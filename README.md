...
🎯 Objective
To build an interactive quiz application
To practice JavaScript-based dynamic behavior
To improve understanding of user input and conditional logic
To create a simple and clean user interface
